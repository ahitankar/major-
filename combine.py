...
def print_eye_pos(img, left, right):
    if left == right and left != 0:
        ...
        if left == 1:
            ...
            cv2.imwrite("proof/looking_left.png", image1)
            print('Looking left')
            text = 'Looking left'
        elif left == 2:
            image1 = pyautogui.screenshot()
            image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
            cv2.imwrite("proof/looking_right.png", image1)
            print('Looking right')
            text = 'Looking right'
        elif left == 3:
            image1 = pyautogui.screenshot()
            image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
            cv2.imwrite("proof/looking_up.png", image1)
            print('Looking up')
            text = 'Looking up'
    ...
    while (True):
        ...
        for rect in rects:
            ...
            if cnt_outer > 3 and cnt_inner > 2:
                image1 = pyautogui.screenshot()
                image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                cv2.imwrite("proof/mouth_open.png", image1)
                print('Mouth open')
        ...
        if ret == True:
            ...
            for face in faces:
                ...
                if ang1 >= 48:
                    image1 = pyautogui.screenshot()
                    image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                    cv2.imwrite("proof/head_dowm.png", image1)
                    print('Head down')
                    cv2.putText(img, 'Head down', (30, 30), font, 2, (255, 255, 128), 3)
                elif ang1 <= -48:
                    image1 = pyautogui.screenshot()
                    image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                    cv2.imwrite("proof/head_up.png", image1)
                    print('Head up')
                ...
                if ang2 >= 48:
                    image1 = pyautogui.screenshot()
                    image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                    cv2.imwrite("proof/head_right.png", image1)
                    print('Head right')
                    cv2.putText(img, 'Head right', (90, 30), font, 2, (255, 255, 128), 3)
                elif ang2 <= -48:
                    image1 = pyautogui.screenshot()
                    image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                    cv2.imwrite("proof/head_left.png", image1)
                    print('Head left')
    ...
    while (True):
        ...
        for i in range(nums[0]):
            ...
            if int(classes[0][i] == 67):
                image1 = pyautogui.screenshot()
                image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
                cv2.imwrite("proof/mobile_phone_detected.png", image1)
                print('Mobile Phone detected')
        if count == 0:
            image1 = pyautogui.screenshot()
            image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
            cv2.imwrite("proof/no_person_detected.png", image1)
            print('No person detected')
        elif count > 1:
            image1 = pyautogui.screenshot()
            image1 = cv2.cvtColor(np.array(image1), cv2.COLOR_RGB2BGR)
            cv2.imwrite("proof/more_than_one_person.png", image1)
